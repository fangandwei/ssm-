...
CREATE TABLE `stu_hom` (
  `id` int(11) NOT NULL auto_increment COMMENT '主键',
  `sid` int(11) NOT NULL COMMENT '外键  学生id',
  `hid` int(11) NOT NULL COMMENT '外键  作业id',
  `state` int(11) NOT NULL COMMENT '该作业的状态',
  `mytext` text NOT NULL COMMENT '该学生的作业',
  PRIMARY KEY  (`id`),
  KEY `z_h_forein` (`hid`),
  KEY `z_s_forein` (`sid`),
...
(1,1,1,1,'         1. 源码，反码，补码的区别？\r\ndjasidjasidjaisdjasjdiasjdiasjdiaa\r\n\r\n2.冯诺依曼计算机体系包括哪些内容？\r\ndkasdokasodkaosdkasokdas\r\n\r\n3.计算机存储容量的计算方式？\r\ndkasodkaoskdaoskdosakdoaskdaoskdoas\r\n\r\n\r\n       '),
(2,2,1,1,''),
(3,3,1,0,''),
(4,4,1,0,''),
(5,5,1,1,'');
